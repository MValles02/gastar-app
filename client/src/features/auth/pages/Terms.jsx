        ...
        <div className="auth-shell text-sm text-app">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <Section title="1. Aceptacion de los terminos">
              <p>
                Al crear una cuenta y usar Gastar, aceptas estos terminos y condiciones de uso. Si
                no estas de acuerdo, no uses la aplicacion.
              </p>
            </Section>

            <Section title="2. Descripcion del servicio">
              <p>
                Gastar es una aplicacion de seguimiento de finanzas personales que te permite
                registrar ingresos, gastos y transferencias entre tus propias cuentas, y visualizar
                resumenes de tu actividad financiera.
              </p>
            </Section>
            ...
            <Section title="3. Uso aceptable">
              ...
              <ul className="mt-2 list-inside list-disc space-y-1">
                ...
                <li>
                  No realizar ingenieria inversa ni intentar vulnerar la seguridad del servicio
                </li>
            ...
            <Section title="4. Tu cuenta">
              <p>
                ...
                que ocurra bajo tu cuenta. Notificanos inmediatamente ante cualquier uso no
                autorizado.
              </p>
            </Section>
            ...
            <Section title="5. Tus datos">
              <p>
                Los datos financieros que ingresas en Gastar son tuyos. No los usamos para ningun
                fin distinto al de mostrartelos a vos. Ver nuestra{' '}
            ...
            <Section title="6. Disponibilidad del servicio">
              <p>
                Gastar se ofrece &ldquo;tal como esta&rdquo;. No garantizamos disponibilidad
                ininterrumpida ni ausencia de errores. Podemos modificar, suspender o discontinuar
                el servicio en cualquier momento, notificandote con razonable anticipacion cuando
                sea posible.
              </p>
            </Section>
            ...
            <Section title="7. Limitacion de responsabilidad">
              <p>
                Gastar es una herramienta de registro personal. No somos responsables por decisiones
                financieras tomadas en base a la informacion mostrada en la aplicacion. Los datos
                son tan precisos como los que vos ingresas.
              </p>
            </Section>

            <Section title="8. Modificaciones">
              <p>
                Podemos actualizar estos terminos. Te notificaremos por correo ante cambios
                relevantes. El uso continuado implica aceptacion de los terminos actualizados.
              </p>
            </Section>

            <Section title="9. Ley aplicable">
              <p>Estos terminos se rigen por las leyes de la Republica Argentina.</p>
            </Section>
