...
import ThemeToggle from '../../../shared/components/ui/ThemeToggle.js';
...
export default function AuthShell({ title, subtitle, children, footer, backLink, className }: Props): JSX.Element {
  return (
