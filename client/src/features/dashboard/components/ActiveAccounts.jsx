...
import AccountCard from '../../../shared/components/ui/AccountCard.jsx';
...
function sortAccounts(accounts, sort) {
  return [...accounts].sort((a, b) => {
    if (sort === 'balance-desc')
      return Number.parseFloat(b.balanceArs) - Number.parseFloat(a.balanceArs);
    if (sort === 'balance-asc')
      return Number.parseFloat(a.balanceArs) - Number.parseFloat(b.balanceArs);
