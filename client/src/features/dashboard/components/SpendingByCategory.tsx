...
import type { CategoryReportItem } from '../../reports/services/reports.js';
...
export default function SpendingByCategory({ data }: Props): JSX.Element {
    ...
    <section className="section-block">
      ...
      <div className="list-surface divide-y divide-border-default/40">
        {items.map((item) => {
          ...
          const Icon = getCategoryIcon(item.icon ?? null) ?? Tag;
          return (
