...
import { formatCurrency, formatDateShort, getAmountTone } from '../../../shared/utils/formatters.js';
...
export default function RecentTransactions({ transactions }: Props): JSX.Element {
  return (
              ...
              <div key={tx.id} className="list-row flex-col items-start gap-1.5">
                ...
                <div className="flex items-center gap-3 w-full">
                  ...
                  >
                    ...
                    {formatCurrency(Number.parseFloat(String(tx.amount)))}
                  </span>
                </div>
