...
import type { TransactionWithRelations } from '../services/transactions.js';
...
export default function TransactionList({ transactions, onEdit, onDelete }: Props): JSX.Element {
                ...
                <div key={tx.id} className="list-row flex-col items-start gap-1.5">
                  ...
                  <div className="flex items-center gap-3 w-full">
                    ...
                    >
                      ...
                      {formatCurrency(Number.parseFloat(String(tx.amount)), tx.account?.currency || 'ARS')}
