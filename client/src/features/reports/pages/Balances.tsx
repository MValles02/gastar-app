...
import { formatCurrency, getAmountTone } from '../../../shared/utils/formatters.js';
import { getErrorMessage } from '../../../shared/utils/errors.js';
import type { MonthlyData } from '../services/reports.js';
...
export default function Balances(): JSX.Element {
  ...
  const load = useCallback(async (year: string | number) => {
    setLoading(true);
    setError('');
    try {
      ...
      <div className="space-y-6">
        ...
        {error ? (
          <PageErrorState
            ...
            message={error}
            onAction={() => void load(appliedYear)}
          />
        ) : null}
