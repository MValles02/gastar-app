...
} from '../../transactions/components/TransactionComposerUI.js';
...
function MockField({ label, value, icon: Icon }: MockFieldProps): JSX.Element {
  return (
...
export default function TutorialStep(): JSX.Element {
