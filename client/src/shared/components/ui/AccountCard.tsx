import { Pencil, Trash2, Wallet, Landmark, CreditCard, Banknote, TrendingUp, type LucideIcon } from 'lucide-react';
...
export default function AccountCard({ account, onEdit, onDelete }: Props): JSX.Element {
  const Icon = typeIcons[account.type] ?? Wallet;
  const balance = Number.parseFloat(String(account.balance));
