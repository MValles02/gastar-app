...
import { useOnboarding } from '../../../features/onboarding/OnboardingContext.js';
import GastarLogo from '../ui/GastarLogo.js';
...
export default function MobileDrawer({ isOpen, onClose }: Props): JSX.Element {
